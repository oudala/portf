...
const projects: Project[] = [
    ...
    githubUrl: "https://github.com/oudala/API-REST-s-curis-e-de-gestion-de-t-ches-collaboratives",
  },
    {
    id: "memory-hashmap",
    ...
    githubUrl: "https://github.com/oudala/memorymap",
  },
    {
    id: "myorm",
    ...
    githubUrl: "https://github.com/oudala/My-ORM",
  },
  {
    id: "multimodal-store",
    ...
    githubUrl: "https://github.com/oudala/AI-Powered-Visual-and-Voice-Product-Search",
  },
  {
    ...
    githubUrl: "https://github.com/oudala/invoices-management",
  },
]
    ...
    <div className={`grid gap-8 ${isReversed ? "md:grid-cols-[3fr_2fr]" : "md:grid-cols-[2fr_3fr]"} items-center`}>
      <div className={`order-2 ${isReversed ? "md:order-1" : "md:order-2"}`}>
        <a 
          ...
          className="block overflow-hidden border-2 border-black shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
        >
